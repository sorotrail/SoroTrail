...
func (c *ClickHouse) GetIngestionState(ctx context.Context, network string) (IngestionState, error) {
...
func (c *ClickHouse) Stats(ctx context.Context, network string) (Stats, error) {
	return Stats{}, nil
}
