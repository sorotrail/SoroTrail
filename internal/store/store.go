...
type Store interface {
	...
	// PoolHealthy returns a cached indicator of Postgres pool health.
	// When false, the most recent background health check or reconnect
	// attempt failed and the pool may not accept queries.
	PoolHealthy() bool
}
